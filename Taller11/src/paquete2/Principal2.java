...
public class Principal2 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < datos001.length; i++) {
            ...
            MenuNinios mn = new MenuNinios(NomPlato, vInicial, vH, vP);
            lista.add(mn);
        }
        for (int i = 0; i < datos002.length; i++) {
            ...
            MenuEconom mn = new MenuEconom(NomPlato, vInicial, por);
            lista.add(mn);
        }
        for (int i = 0; i < datos003.length; i++) {
            ...
            MenuDia mn = new MenuDia(NomPlato, vInicial, vP, vB);
            lista.add(mn);
        }
        ...
        for (int i = 0; i < datos004.length; i++) {
            ...
            MenuCarta mn = new MenuCarta(NomPlato, vInicial, vG, vB, por);
            lista.add(mn);
        }

        // Fin de solución
        for (int i = 0; i < lista.size(); i++) {
            lista.get(i).establecerVMenu();
        }
